...
do
  ...
  -- This is useful for file watchers that watch for changes and get confused if
  ...
  end, { desc = 'Copy relative path of the current file to the clipboard' })
  ...
  vim.keymap.set('n', '<leader>pu', function() vim.pack.update() end, { desc = '[P]lugin [U]pdate' })
  vim.keymap.set('n', '<leader>ps', function() vim.pack.update(nil, { offline = true }) end, { desc = '[P]lugin [S]tatus' })
...
-- DISABLED: user uses snacks.picker instead.
...
do
  ...
  require('conform').setup {
    ...
    formatters_by_ft = {
      ...
      -- json = { 'prettierd', 'biome', 'prettier', stop_after_first = true },
    },
  }
...
-- blink.cmp is configured in lua/custom/plugins/blink-cmp.lua
-- luasnip setup
-- ============================================================
do
  -- [[ Snippet Engine ]]
...
do
  ...
  -- User custom colorschemes preserved from previous lazy.nvim inline specs
  vim.pack.add { { src = gh 'everviolet/nvim', name = 'evergarden' } }
